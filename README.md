...
- 機能を細分化しそれぞれのissueに落とし込み、都度テストを繰り返し正常な動作、バグを洗い出しながらのGit flowを意識した開発
...
初めてのプログラミング、IoTの制作でしたが、完成し,実際に鍵の開閉ができた時はとても達成感を感じ、人と物、人と人の繋がりに効率をもたらすIT産業の物作りに心を奪われ、ITの道へ進もうと決断した経験でした。  
生活の中の小さなことかもしれませんが、効率化できたことによるストレスの軽減や生活の質の向上は、IT産業の醍醐味だと思います。  
今後も生活に役立つIot、Webアプリ等、積極的に自作していきたいです。  
